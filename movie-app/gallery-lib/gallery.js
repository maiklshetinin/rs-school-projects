...
//------------------------------------------------------------------------------------------------------------setParameters()
    ...
    setParameters() {
        this.gallery = this.containerNode.querySelector(`.${GalleryClassName}`)
        const galleryWidth=this.gallery.getBoundingClientRect()


        // const coordsContainer = this.containerNode.getBoundingClientRect()
        this.width = galleryWidth.width
    ...
    setEvents() {
        ...
        window.addEventListener('load', this.debouncedResizeGallery)
    ...
    destroyEvents() {
        ...
        window.removeEventListener('load', this.debouncedResizeGallery)
